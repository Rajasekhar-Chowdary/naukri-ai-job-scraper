...
import os
import tempfile
from src.database import init_db, insert_jobs, get_jobs, get_stats, save_feedback, get_feedback_counts, update_job_scores
...
def test_get_jobs_filtering():
    ...
    update_job_scores("http://a.com/1", {"AI_Score": 90, "Score_Skill": 80, "Score_Title": 85, "Score_Desc": 88, "Score_Exp": 90})
    update_job_scores("http://b.com/1", {"AI_Score": 30, "Score_Skill": 20, "Score_Title": 25, "Score_Desc": 30, "Score_Exp": 40})
